  ...
  return (
    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous:'bg-white border border-gray-300 rounded-lg [&>svg]:fill-teal-600',
        button_next: 'bg-teal-600 border-2 border-teal-600 rounded-lg [&>svg]:fill-white ml-2',
        today: 'text-teal-500',
