...
const TopHeader = ({ userType }: TopHeaderProps) => {
  ...
  return (
    <div className="absolute static top-0 flex flex-row w-screen border border-gray-200 py-8 px-6 place-content-between">
      ...
      <div className="flex flex-row justify-self-end place-items-center gap-x-2">
        ...
        <div>
          <label htmlFor="check" className="flex bg-gray-200 cursor-pointer relative w-[36px] h-[20px] rounded-full">
